...
$Query = "
  ...
  and CP_LastInstallationError >= 2
  group by cdr.CP_LastInstallationError
"
$data.InstallFailures = Get-SQLData -Query $Query
...
'HTMLFragments'=@($HTMLTop,$HTMLhead,$html_InstallFailures,$HTMLpost)}
...
$html | Out-File -FilePath C:\Temp\ClientInstallationFailure.html
