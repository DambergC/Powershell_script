...
Dashboard -Name 'Dashimo Test' -FilePath $PSScriptRoot\DashboardEasy06.html {
    Section -Name 'Test' -Collapsable {
        Container {
            Panel {
                ...
                } -Buttons @() -DisableSearch -PagingOptions $PagingOptions -HideFooter -HideButtons -DisableSelect -DisablePaging
            }
        }
    }
} -Show