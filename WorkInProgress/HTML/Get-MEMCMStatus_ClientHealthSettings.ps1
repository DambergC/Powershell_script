...
$Data.ClientHealthSettings = Get-SQLData -Query $Query 
...
$params = @{'As'='Table';
'PreContent'="<h4>Client Settings </h4>";
'EvenRowCssClass'='even';
'OddRowCssClass'='odd';
'MakeTableDynamic'=$true;
'TableCssClass'='grid';}

$html_ClientSettings = $data.ClientHealthSettings |
ConvertTo-EnhancedHTMLFragment @params -Properties "SettingsID","DDRinactiveInterval","SWinactiveInterval","HWinactiveInterval","StatusinactiveInterval"."PolicyinactiveInterval"."CleanUpInterval"
...
'HTMLFragments'=@($HTMLTop,$HTMLhead,$html_ClientSettings,$HTMLpost)}
...
$html | Out-File -FilePath C:\Temp\ClientSettings.html
